...
//https://www.designcise.com/web/tutorial/how-to-append-an-html-string-to-an-existing-dom-element-using-javascript
    ...
    stringItems = `${stringItems}\n\n*****************\nSubtotal: *${maskedSumTotal}* \n*****************\nObservações: `;
		...
		//parentElement.innerHTML = result.join('');//vamos evitar por causa da peformance!
    //parentElement.innerHTML = ''; //resetando p vazio pode
    parentElement.replaceChildren();
    const fragment = document.createRange().createContextualFragment(result.join(''));
